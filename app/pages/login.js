...
//     try {
//       const response = await axios.post("http://localhost:5000/api/users/validate", { id });
...
//     } catch (error) {
//       console.error(error);
//       alert("User not found. Please create a new ID.");
//     }
//   };
...
//     try {
//       await axios.post("http://localhost:5000/api/users/create", { id, username, password });
...
//           <p className="text-sm text-gray-600">Don't have an ID?</p>
//           <button
//             onClick={createNewId}
